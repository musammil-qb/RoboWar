...
def main(image_path=None, video_path=None, disable_bot=True):
    ...
    try:
        algorithm(detection, bot,test=True,image=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--disable_bot", action="store_true", help="Disable bot detection.")
